...
class AmclNode
{
  ...
  private:
    ...
    void updatePublisherTf(const std_msgs::Bool::ConstPtr& msg); 
    ...
    ros::Subscriber tf_updater_sub_;
        ...
        first_reconfigure_call_(true)
{
  ...
  // Add topic to update the tf_publisher
  tf_updater_sub_ = nh_.subscribe("/mbzirc2020_0/localization_switch/amcl_broadcast", 2, &AmclNode::updatePublisherTf, this);
...
void AmclNode::updatePublisherTf(const std_msgs::Bool::ConstPtr& msg)
{
  tf_broadcast_ = msg->data;
}
